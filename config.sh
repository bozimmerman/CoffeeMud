...
JAVACPATH="$Java_Home/bin/javac -nowarn -Xlint:-deprecation -g -encoding UTF8 -classpath .:./lib/js.jar:./lib/jzlib.jar" 
...
find com -name "*.java" | xargs $JAVACPATH -nowarn -Xlint:-deprecation -Xlint:none -g -classpath ".:lib/jzlib.jar:lib/js.jar"
