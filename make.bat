...
%JAVACPATH% com/planet_ink/coffee_mud/Libraries/intermud/*.java
%JAVACPATH% com/planet_ink/coffee_mud/Libraries/intermud/cm1/*.java
%JAVACPATH% com/planet_ink/coffee_mud/Libraries/intermud/cm1/commands/*.java
%JAVACPATH% com/planet_ink/coffee_mud/Libraries/intermud/i3/*.java
%JAVACPATH% com/planet_ink/coffee_mud/Libraries/intermud/i3/net/*.java
%JAVACPATH% com/planet_ink/coffee_mud/Libraries/intermud/i3/packets/*.java
%JAVACPATH% com/planet_ink/coffee_mud/Libraries/intermud/i3/persist/*.java
%JAVACPATH% com/planet_ink/coffee_mud/Libraries/intermud/i3/server/*.java
%JAVACPATH% com/planet_ink/coffee_mud/Libraries/intermud/imc2/*.java
