...
REM **  path.  E.G. c:\j2sdk1.4.0\bin\java
java -classpath ".;.\lib\js.jar;.\lib\jzlib.jar" -Xms65535000 -Xmx115535000 com.planet_ink.coffee_mud.application.MUD "Your Muds Name"
