...
public class Gaoler extends StdCharClass
{
	...
	public Gaoler()
	{
		...
		if(!loaded())
		{
			...
			CMLib.ableMapper().addCharAbilityMapping(ID(),16,"Torturesmithing",false);
			...
			CMLib.ableMapper().addCharAbilityMapping(ID(),25,"Skill_Chirgury",false);
			CMLib.ableMapper().addCharAbilityMapping(ID(),30,"Amputation",true);
			
			// to separate from artisam
			CMLib.ableMapper().addCharAbilityMapping(ID(),30,"MasterArmorsmithing",0,"",false,true);
			CMLib.ableMapper().addCharAbilityMapping(ID(),30,"MasterTailoring",0,"",false,true);
			CMLib.ableMapper().addCharAbilityMapping(ID(),30,"MasterWeaponsmithing",0,"",false,true);
			CMLib.ableMapper().addCharAbilityMapping(ID(),30,"MasterCostuming",0,"",false,true);
			CMLib.ableMapper().addCharAbilityMapping(ID(),30,"MasterLeatherWorking",0,"",false,true);
			...
			CMLib.ableMapper().addCharAbilityMapping(ID(),30,"Cobbling",0,"",false,true);
			...
			CMLib.ableMapper().addCharAbilityMapping(ID(),30,"Embroidering",0,"",false,true);
			CMLib.ableMapper().addCharAbilityMapping(ID(),30,"Engraving",0,"",false,true);
			...
			CMLib.ableMapper().addCharAbilityMapping(ID(),30,"Weaponsmithing",0,"",false,true);
			CMLib.ableMapper().addCharAbilityMapping(ID(),30,"Shipwright",0,"",false,true);
			CMLib.ableMapper().addCharAbilityMapping(ID(),30,"Wainwrighting",0,"",false,true);
			...
			CMLib.ableMapper().addCharAbilityMapping(ID(),30,"Construction",0,"",false,true);
