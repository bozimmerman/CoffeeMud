...
public class Diviner extends SpecialistMage
{
    ...
    public void initializeClass()
    {
        ...
        /*NEW*/CMLib.ableMapper().addCharAbilityMapping(ID(),6,"Spell_PryingEye",25,true);
        ...
        /*NEW*/CMLib.ableMapper().addCharAbilityMapping(ID(),17,"Spell_DiviningEye",25,"",true,false,CMParms.parseSemicolons("Spell_PryingEye",true),"");
