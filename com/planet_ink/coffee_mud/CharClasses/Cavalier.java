...
public class Cavalier extends StdCharClass
{
	...
	public void initializeClass()
	{
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(),3,"Fighter_CallSteed",false); //TODO
		CMLib.ableMapper().addCharAbilityMapping(ID(),3,"Skill_RopeTricks",false); //TODO
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(),4,"Skill_BroncoBusting",false); //TODO
		CMLib.ableMapper().addCharAbilityMapping(ID(),4,"Skill_AweMounts",false); //TODO
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(),7,"Skill_TendMount",false); //TODO

		CMLib.ableMapper().addCharAbilityMapping(ID(),8,"Fighter_FavoredMount",true); //TODO
		CMLib.ableMapper().addCharAbilityMapping(ID(),8,"Skill_Disarm",false);
		CMLib.ableMapper().addCharAbilityMapping(ID(),8,"Fighter_PushBack",false); //TODO
		CMLib.ableMapper().addCharAbilityMapping(ID(),8,"Fighter_RearGuard",false); //TODO

		CMLib.ableMapper().addCharAbilityMapping(ID(),9,"Skill_IndoorRiding",true); //TODO
		CMLib.ableMapper().addCharAbilityMapping(ID(),9,"Skill_Attack2",false);
		CMLib.ableMapper().addCharAbilityMapping(ID(),9,"Fighter_ScoutAhead",false); //TODO
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(),10,"Fighter_CommandMount",false); //TODO
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(),18,"Fighter_FavoredMount3",true); //TODO
		...
		CMLib.ableMapper().addCharAbilityMapping(ID(),23,"Fighter_FavoredMount3",true); //TODO
