...
public interface Law extends CMCommon
{
	...
	public static final String defaultLaw=
		...
		"JAIL=@\n"+
		"RELEASEROOM=@\n"+
		"WARNINGMSG="+CMLib.lang()._("Your behavior is unacceptable.  Do not repeat this offense.  You may go.")+"\n"+
		"THREATMSG="+CMLib.lang()._("That behavior is NOT tolerated here.  Keep your nose clean, or next time I may not be so lenient.  You may go.")+"\n"+
		"JAIL1MSG="+CMLib.lang()._("You are hereby sentenced to minimum jail time.  Take away the prisoner!")+"\n"+
		"JAIL2MSG="+CMLib.lang()._("You are hereby sentenced to jail time.  Take away the prisoner!")+"\n"+
		"JAIL3MSG="+CMLib.lang()._("You are hereby sentenced to hard jail time.  Take away the prisoner!")+"\n"+
		"JAIL4MSG="+CMLib.lang()._("You are hereby sentenced to rot in jail.  Take away the prisoner!")+"\n"+
		"PAROLE1MSG="+CMLib.lang()._("You are hereby sentenced to a short period under the prisoner's geas. Perhaps that will make you think!")+"\n"+
		"PAROLE2MSG="+CMLib.lang()._("You are hereby sentenced to a period under the prisoner's geas. That will teach you, I think.")+"\n"+
		"PAROLE3MSG="+CMLib.lang()._("You are hereby sentenced to hard time under the prisoner's geas! That will teach you!")+"\n"+
		"PAROLE4MSG="+CMLib.lang()._("You are hereby sentenced to rot under the prisoner's geas!  Don't let me see you again!")+"\n"+
		"PAROLEDISMISS="+CMLib.lang()._("Now, get out of my sight!")+"\n"+
		"PREVOFFMSG="+CMLib.lang()._("You have been warned about this behavior before.")+"\n"+
		"EXECUTEMSG="+CMLib.lang()._("You are hereby sentenced to a brutal death.  Sentence to be carried out IMMEDIATELY!")+"\n"+
		"LAWFREE="+CMLib.lang()._("You are free to go.")+"\n"+
		"CHITCHAT="+CMLib.lang()._("\"You didn't really think you could get away with it did you?\" \"You are REALLY in for it!\" \"Convicts like you are a dime a dozen.\" \"MAKE WAY! DEAD MAN WALKING!\" \"You are gonna GET it.\" \"I love my job.\"")+"\n"+
		"CHITCHAT2="+CMLib.lang()._("\"You didn't really think you would get away with it did you?\" \"I hope you aren't claustrophobic!\" \"Remember not to drop your soap in there.\" \"MAKE WAY! DEAD MAN WALKING!\" \"I recommend you hold your breathe while you're in there -- I always do.  It stinks!\" \"Putting away scum like you makes it all worthwhile\"")+"\n"+
		"CHITCHAT3="+CMLib.lang()._("\"This is for your own good, so please don't resist.\" \"You understand that your detention is mandatory I hope.\" \"Just doing my job.\" \"Been a nice day, don't ya think?\" \"We're almost there, don't worry.\" \"Not much farther now.\"")+"\n"+
		"RESISTWARNMSG="+CMLib.lang()._("I said SIT DOWN! NOW!")+"\n"+
		"NORESISTMSG="+CMLib.lang()._("Good.  Now hold still.")+"\n"+
		"ACTIVATED=FALSE\n"+
		"RESISTFIGHTMSG="+CMLib.lang()._("Resisting arrest?! How DARE you!")+"\n"+
		"COPKILLERMSG="+CMLib.lang()._("COP-KILLER!!!!! AAARRRGGGHHHH!!!!!")+"\n"+
		"RESISTMSG="+CMLib.lang()._("Resisting arrest eh?  Well, have it your way.")+"\n"+
		"PROTECTED=+ADJINT 3\n"+
		"ARRESTMOBS=true\n"+
		...
		"JAIL3TIME=80\n"+
		"JAIL4TIME=160\n"+
		"RESISTINGARREST=;;"+CMLib.lang()._("resisting arrest")+";jail1;"+CMLib.lang()._("Resisting arrest by a lawful officer is a serious crime.")+"\n"+
		"TRESPASSING=!home !indoors;!recently;"+CMLib.lang()._("trespassing")+";jail3;"+CMLib.lang()._("Your kind are not allowed here.")+"\n"+
		"NUDITY=!home !indoors;witness !recently;"+CMLib.lang()._("indecent exposure")+";warning;"+CMLib.lang()._("Nudity below the waist violates our high moral code.  Use the 'outfit' command if you need clothes!")+"\n"+
		"ARMED=\n"+
		"ASSAULT=;;"+CMLib.lang()._("assaulting <T-NAME>")+";jail4;"+CMLib.lang()._("Assault is a hideous offense.")+"\n"+
		"MURDER=;;"+CMLib.lang()._("murdering <T-NAME>")+";death;"+CMLib.lang()._("Murder is a barbarous offense.")+"\n"+
		"PROPERTYROB=;;"+CMLib.lang()._("robbing the property of <T-NAME>")+";jail3;"+CMLib.lang()._("Robbery violates our high moral code.")+"\n"+
		"TAXEVASION=;;"+CMLib.lang()._("evading taxes;jail1")+";"+CMLib.lang()._("Paying taxes and dieing are our solemn duties to the state.")+"\n"+
		"TREASURY=\n"+
		"PROPERTYTAX=0\n"+
		"SALESTAX=0\n"+
		"CITTAX=10\n"+
		"THIEF_SWIPE=;;"+CMLib.lang()._("robbing <T-NAME>")+";jail2;"+CMLib.lang()._("Swiping violates our high moral code.")+"\n"+
		"THIEF_STEAL=;;"+CMLib.lang()._("robbing <T-NAME>")+";jail3;"+CMLib.lang()._("Stealing violates our high moral code.")+"\n"+
		"THIEF_TRAP=!home;;"+CMLib.lang()._("setting traps in city limits")+";jail3;"+CMLib.lang()._("Trapping puts us all in mortal danger.")+"\n"+
		"THIEF_BRIBE=;;"+CMLib.lang()._("bribing <T-NAME>")+";jail2;"+CMLib.lang()._("Bribing is a violation of our moral code.")+"\n"+
		"THIEF_CON=;;"+CMLib.lang()._("conning <T-NAME>")+";jail2;"+CMLib.lang()._("Conning and deception is a violation of our moral code.")+"\n"+
		"THIEF_EMBEZZLE=;;"+CMLib.lang()._("embezzling <T-NAME>")+";jail4;"+CMLib.lang()._("Embezzling money is a form of vicious theft!")+"\n"+
		"THIEF_CONTRACTHIT=;;"+CMLib.lang()._("taking out contract on <T-NAME>'s life")+";death;"+CMLib.lang()._("Murder by contract is a barbarous offense.")+"\n"+
		"THIEF_DEATHTRAP=;;"+CMLib.lang()._("setting a death trap")+";death;"+CMLib.lang()._("Murder by trapping is a barbarous offense.")+"\n"+
		"THIEF_FORGERY=;;"+CMLib.lang()._("forgery")+";jail2;"+CMLib.lang()._("Forgery is deceptive and quite illegal.")+"\n"+
		"THIEF_RACKETEER=;;"+CMLib.lang()._("racketeering <T-NAME>")+";jail3;"+CMLib.lang()._("Racketeering is a form of vicious theft.")+"\n"+
		"THIEF_ROBBERY=;;"+CMLib.lang()._("robbing <T-NAME>")+";jail3;"+CMLib.lang()._("Robbery violates our high moral code.")+"\n"+
		"INEBRIATION=!home !pub !tavern !inn !bar;!recently;"+CMLib.lang()._("public intoxication")+";parole1;"+CMLib.lang()._("Drunkenness is a demeaning and intolerable state.")+"\n"+
		"POISON_ALCOHOL=!home !pub !tavern !inn !bar;!recently;"+CMLib.lang()._("public intoxication")+";parole1;"+CMLib.lang()._("Drunkenness is a demeaning and intolerable state.")+"\n"+
		"POISON_FIREBREATHER=!home !pub !tavern !inn !bar;!recently;"+CMLib.lang()._("public intoxication")+";parole1;"+CMLib.lang()._("Drunkenness is a demeaning and intolerable state.")+"\n"+
		"POISON_LIQUOR=!home !pub !tavern !inn !bar;!recently;"+CMLib.lang()._("public intoxication")+";parole1;"+CMLib.lang()._("Drunkenness is a demeaning and intolerable state.")+"\n";
}
