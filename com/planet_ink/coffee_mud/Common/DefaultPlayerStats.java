...
public class DefaultPlayerStats implements PlayerStats
{
    ...
    protected static String[] CODES={"CLASS","FRIENDS","IGNORE","TITLES",
                                     ...
                                     "ACCTEXPIRATION","INTRODUCTIONS","JOURNEY"};
    ...
    public void setStat(String code, String val)
    {
        ...
        case 20: journeyString=val; break;
        }
    }
    public int getSaveStatIndex(){return getStatCodes().length-1;}
    ...
    public void setReplyTo(MOB mob, int i){    replyTo=mob;    }
    public int replyType(){return 0;}
    public long replyTime(){return System.currentTimeMillis();}
