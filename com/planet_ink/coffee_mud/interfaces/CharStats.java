...
public class CharStats implements Cloneable
{
	...
	public final static double AVG_VALUE=12.0;
	...
	protected CharClass MyClass=new StdCharClass();
	protected Race MyRace=new StdRace();
	public char getGender(){return Gender;}
	public CharClass getMyClass(){return MyClass;}
	public Race getMyRace(){return MyRace;}
	...
	public CharStats cloneCharStats()
	{
		...
		{
			newOne=(CharStats) new CharStats();
		}
		return newOne;
	}	
