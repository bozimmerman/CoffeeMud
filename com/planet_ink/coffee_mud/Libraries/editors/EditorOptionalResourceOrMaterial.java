 ...
 */
public class EditorOptionalResourceOrMaterial extends AbilityParmEditorImpl
{
	public EditorOptionalResourceOrMaterial()
	{
		super("OPTIONAL_RESOURCE_OR_MATERIAL",CMLib.lang().L("Rsc/ Mat"),ParmType.CHOICES);
	}
