 ...
 */
public class EditorContainerTypeOrLidlockOrRidebasis extends AbilityParmEditorImpl
{
	public EditorContainerTypeOrLidlockOrRidebasis()
	{
		super("CONTAINER_TYPE_OR_LIDLOCK_OR_RIDEBASIS",CMLib.lang().L("Con./Ride"),ParmType.SPECIAL);
	}
