 ...
 */
public class EditorAttackModification extends AbilityParmEditorImpl
{
	public EditorAttackModification()
	{
		super("ATTACK_MODIFICATION",CMLib.lang().L("Att."),ParmType.NUMBER);
	}
