 ...
 */
public class EditorInstrumentType extends AbilityParmEditorImpl
{
	public EditorInstrumentType()
	{
		super("INSTRUMENT_TYPE",CMLib.lang().L("Instrmnt"),ParmType.CHOICES);
	}
