 ...
 */
public class EditorMushroomName extends AbilityParmEditorImpl
{
	public EditorMushroomName()
	{
		super("MUSHROOM_NAME",CMLib.lang().L("Mushroom Final Name"),ParmType.STRING);
	}
