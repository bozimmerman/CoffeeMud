 ...
 */
public class EditorClanItemCodenumber extends AbilityParmEditorImpl
{
	public EditorClanItemCodenumber()
	{
		super("CLAN_ITEM_CODENUMBER",CMLib.lang().L("Typ."),ParmType.CHOICES);
	}
