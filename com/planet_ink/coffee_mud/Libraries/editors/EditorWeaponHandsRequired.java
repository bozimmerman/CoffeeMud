 ...
 */
public class EditorWeaponHandsRequired extends AbilityParmEditorImpl
{
	public EditorWeaponHandsRequired()
	{
		super("WEAPON_HANDS_REQUIRED",CMLib.lang().L("Hand"),ParmType.NUMBERORNULL);
	}
