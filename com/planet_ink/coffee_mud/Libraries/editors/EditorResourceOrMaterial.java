 ...
 */
public class EditorResourceOrMaterial extends AbilityParmEditorImpl
{
	public EditorResourceOrMaterial()
	{
		super("RESOURCE_OR_MATERIAL",CMLib.lang().L("Rsc/ Mat"),ParmType.CHOICES);
	}
