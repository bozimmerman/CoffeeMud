 ...
 */
public class EditorClanExperienceCostAmount extends AbilityParmEditorImpl
{
	public EditorClanExperienceCostAmount()
	{
		super("CLAN_EXPERIENCE_COST_AMOUNT",CMLib.lang().L("Exp"),ParmType.NUMBER);
	}
