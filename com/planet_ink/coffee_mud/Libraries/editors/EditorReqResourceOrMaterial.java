 ...
 */
public class EditorReqResourceOrMaterial extends AbilityParmEditorImpl
{
	public EditorReqResourceOrMaterial()
	{
		super("REQ_RESOURCE_OR_MATERIAL",CMLib.lang().L("Rsc/ Mat"),ParmType.CHOICES);
	}
