 ...
 */
public class EditorBodyPartDesc extends AbilityParmEditorImpl
{
	public EditorBodyPartDesc()
	{
		super("BODY_PART_DESC",CMLib.lang().L("Body Part"),ParmType.STRINGORNULL);
	}
