 ...
 */
public class EditorContainerCapacity extends AbilityParmEditorImpl
{
	public EditorContainerCapacity()
	{
		super("CONTAINER_CAPACITY",CMLib.lang().L("Cap."),ParmType.NUMBER);
	}
