 ...
 */
public class EditorRoomClassIdOrNone extends AbilityParmEditorImpl
{
	public EditorRoomClassIdOrNone()
	{
		super("ROOM_CLASS_ID_OR_NONE",CMLib.lang().L("Class ID"),ParmType.CHOICES);
	}
