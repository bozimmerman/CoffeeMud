 ...
 */
public class EditorOptionalAmountRequired extends AbilityParmEditorImpl
{
	public EditorOptionalAmountRequired()
	{
		super("OPTIONAL_AMOUNT_REQUIRED",CMLib.lang().L("Amt"),ParmType.NUMBER);
	}
