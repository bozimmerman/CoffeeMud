 ...
 */
public class EditorBuilderMask extends AbilityParmEditorImpl
{
	public EditorBuilderMask()
	{
		super("BUILDER_MASK",CMLib.lang().L("Builder Mask"),ParmType.STRINGORNULL);
	}
