 ...
 */
public class EditorAllitemClassId extends AbilityParmEditorImpl
{
	public EditorAllitemClassId()
	{
		super("ALLITEM_CLASS_ID",CMLib.lang().L("Class ID"),ParmType.CHOICES);
	}
