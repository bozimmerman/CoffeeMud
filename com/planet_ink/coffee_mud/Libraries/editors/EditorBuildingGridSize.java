 ...
 */
public class EditorBuildingGridSize extends AbilityParmEditorImpl
{
	public EditorBuildingGridSize()
	{
		super("BUILDING_GRID_SIZE",CMLib.lang().L("Grid Size"),ParmType.NUMBER);
	}
