 ...
 */
public class EditorAmountMaterialRequired extends AbilityParmEditorImpl
{
	public EditorAmountMaterialRequired()
	{
		super("AMOUNT_MATERIAL_REQUIRED",CMLib.lang().L("Amt"),ParmType.NUMBER);
	}
