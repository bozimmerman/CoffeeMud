...
public interface MaskingLibrary extends CMLibrary
{
	...
	public final String DEFAULT_MASK_HELP =
		...
		+"+NAMES -bob \"-my name\" etc.. (create name exceptions) <BR>"
		+"-CLASSLEVEL  (<WORD> all current class levels)  <BR>"
		+"-CLASSLEVEL +=1 +>5 +>=7 +<13 +<=20 (create exceptions) <BR>"
		+"-MAXCLASSLEVEL  (<WORD> all max class levels)  <BR>"
		+"-MAXCLASSLEVEL +=1 +>5 +>=7 +<13 +<=20 (create exceptions) <BR>"
