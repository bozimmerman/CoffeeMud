...
public interface MaskingLibrary extends CMObject
{
    ...
    public final String DEFAULT_MASK_HELP =
        ...
        +"-EDUCATIONS (<WORD> all educations, even a lack of a edus) <BR>"
        +"-EDUCATIONS +myedu +thisedu +anyedu etc..  (create exceptions)<BR>"
        +"+EDUCATIONS (do not <WORD> any or no educations) <BR>"
        +"+EDUCATIONS -myedu -anyedu, etc.. (create exceptions) <BR>"
        +"-SECURITY (<WORD> all security flags, even a lack of a security) <BR>"
        +"-SECURITY +cmdrooms +area cmditems etc..  (create exceptions)<BR>"
        +"+SECURITY (do not <WORD> any or no educations) <BR>"
        +"+SECURITY -cmdrooms +area cmditems, etc.. (create exceptions) <BR>"
        ...
        +"-SKILLS +Spell_Sleep(75) etc.. (create exceptions with profficiency) <BR>"
