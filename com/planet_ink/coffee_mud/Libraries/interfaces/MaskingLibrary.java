...
public interface MaskingLibrary extends CMLibrary
{
    ...
    public final String DEFAULT_MASK_HELP =
        ...
        +"+MATERIAL \"-WOODEN\" etc.. (Do not <WORD> items of subtracted materials) <BR>"
        ...
        +"-WORNON \"+TORSO\" etc.. (<WORD> only items wearable on added locs) <BR>"
        +"+WORNON \"-NECK\" etc.. (Do not <WORD> items wearable on subtracted locs) <BR>"
        +"-DISPOSITION \"+ISHIDDEN\" etc.. (<WORD> only with added dispositions) <BR>"
        +"+DISPOSITION \"-ISHIDDEN\" etc.. (Do not <WORD> only with sub disp) <BR>"
        +"-SENSES \"+CANSEEDARK\" etc.. (<WORD> only those with added sens.) <BR>"
        +"+SENSES \"-CANSEEDARK\" etc.. (Do not <WORD> those with subtracted sens.) <BR>"
