...
import com.planet_ink.coffee_mud.Libraries.intermud.i3.ImudServices;
 ...
 * @version 1.1
 * @see com.planet_ink.coffee_mud.Libraries.intermud.i3.server.I3Server
 *
	...
	public void start()
	{
		...
		try
		{
			I3Client.setup(routersList, adminEmail, intermuds,
						   (PersistentPeer)Class.forName("com.planet_ink.coffee_mud.Libraries.intermud.i3.IMudPeer").getDeclaredConstructor().newInstance(),
						   smtpPort);
		}
		catch( final Exception e )
		{
	...
	public boolean tick(final Tickable ticking, final int tickID)
	{
		...
		{// Get new connections
			...
			for(i=0; i<5; i++)
			{
				...
				try
				{
					new_user = (ServerUser)copyObject("com.planet_ink.coffee_mud.Libraries.intermud.i3.IMudOOB");
				}
