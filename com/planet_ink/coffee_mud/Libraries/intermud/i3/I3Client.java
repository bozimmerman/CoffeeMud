...
import com.planet_ink.coffee_mud.Libraries.intermud.i3.entities.I3RMud;
...
import com.planet_ink.coffee_mud.Libraries.intermud.i3.packets.Packet.PacketType;
 ...
 * this object:
 * an implementation of com.planet_ink.coffee_mud.Libraries.intermud.i3.packets.ImudServices
 * an implementation of com.planet_ink.coffee_mud.Libraries.intermud.i3.persist.PersistentPeer
...
public class I3Client implements Runnable, Persistent, Serializable
{
	 ...
	 * be a valid subclass of com.planet_ink.coffee_mud.Libraries.intermud.i3.packets.Packet.
	 * This method will then route the packet to the
	 * currently running Intermud instance.
	 * @param p an instance of a subclass of com.planet_ink.coffee_mud.Libraries.intermud.i3.packets.Packet
	 * @see com.planet_ink.coffee_mud.Libraries.intermud.i3.packets.Packet
	 */
	 ...
	 */
	public static String translateName(String mud)
	{
		if(!isConnected())
			return "";
	...
	static public String registerFakeChannel(final String c)
	{
		...
		imudChans.put(InterProto.I3,c);
		final CMChannel chan=CMLib.channels().createNewChannel(name, imudChans, "+FAKE", new HashSet<ChannelFlag>(),"","");
	 ...
	 * @see com.planet_ink.coffee_mud.Libraries.intermud.i3.ImudServices#getRemoteChannel
	 */
	 ...
	 * @see com.planet_ink.coffee_mud.Libraries.intermud.i3.ImudServices#getChannels
	 */
