		...
		case ROOM:
			if((M!=null)&&(M.location()!=null))
			{
				...
				for(int d=0;d<Directions.NUM_DIRECTIONS();d++)
				{
					...
					if((R2!=null)
					&&(E2!=null)
					&&(CMLib.flags().canBeSeenBy(E2, M)||M.lastLocation()==R2))
					{
				...
				case char_login_credentials:
				{
					...
					if((json != null)&&(json.keySet().size()>0))
					{
						...
						if(json.containsKey("name"))
							...
							user=json.getCheckedString("not_account_or_user_or_username_or_name_"+json.toString());
						final String pw=json.getCheckedString("password");
