...
public class MUD extends Thread implements MudHost
{
	...
	private static final float	  HOST_VERSION_MINOR	= (float)3.09;
	...
	public static void main(String a[])
	{
		...
		if(nameID.equalsIgnoreCase( "TheRealCoffeeMudCopyright2000-2016ByBoZimmerman" ))
			nameID="CoffeeMud";
		...
		while(!bringDown)
		{
			...
			Log.sysOut(Thread.currentThread().getName(),"(C) 2000-2016 Bo Zimmerman");
