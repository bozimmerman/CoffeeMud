...
/*
   Copyright 2000-2019 Bo Zimmerman
...
public class MUD extends Thread implements MudHost
{
	...
	private static final float	  HOST_VERSION_MINOR	= (float)8.3;
	...
	public static void main(final String a[])
	{
		...
		if(nameID.equalsIgnoreCase( "TheRealCoffeeMudCopyright2000-2019ByBoZimmerman" ))
			nameID="CoffeeMud";
		...
		while(!bringDown)
		{
			...
			Log.sysOut(Thread.currentThread().getName(),"(C) 2000-2019 Bo Zimmerman");
