...
public class Spells extends Skills
{
		...
		throws java.io.IOException
	{
		...
		domainName[0]="";
		parseDomainInfo(mob,commands,new XVector<Integer>(Integer.valueOf(Ability.ACODE_SPELL)),levels,domain,domainName);
		final StringBuffer msg=new StringBuffer("");
		msg.append(L("\n\r^HYour @x1spells:^? @x2",domainName[0].replace('_',' '),getAbilities(mob,mob,Ability.ACODE_SPELL,domain[0],true,levels[0]).toString()));
		if(!mob.isMonster())
