...
public class XMLIO
{
	...
	public static void xml(MOB mob,Vector commands)
	{
	...
	public static void infoxml(MOB mob, Vector commands)
	{
		...
		{
			if(level>0)
				mob2.baseCharStats().getCurrentClass().buildMOB(mob2,level,0,150,0,'M');
			roomXML.append("<OBJECT>");
	...
	public static void contentxml(MOB mob, Vector commands)
	{
		if(commands.size()>=1)
		{
	...
	public static void roomxml(MOB mob, Vector commands)
	{
		if(commands.size()>=1)
		{
			String possID=Util.combine(commands,0);
