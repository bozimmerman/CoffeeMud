		...
		while(commands.size()>0)
		{
			...
			try
			{
				...
				for(int r=0;r<roomData.size();r++)
				{
					...
					{
						returnAnError(session,"Malformed room: bad numbits in codeline. Aborting this room "+R.roomID()+", display="+R.displayText()+", description="+R.description()+", numBits="+CMParms.numBits(codeLine)+", area="+areaName,compileErrors,commands);
						continue;
					}
