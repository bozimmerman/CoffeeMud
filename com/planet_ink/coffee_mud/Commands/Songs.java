...
public class Songs  extends Skills
{
		...
		throws java.io.IOException
	{
		...
		domainName[0]="";
		parseDomainInfo(mob,commands,new XVector<Integer>(Integer.valueOf(Ability.ACODE_SONG)),levels,domain,domainName);
		msg.append(L("\n\r^HYour @x1songs:^? @x2",domainName[0].replace('_',' '),getAbilities(mob,mob,Ability.ACODE_SONG,domain[0],true,levels[0]).toString()));
		if(!mob.isMonster())
