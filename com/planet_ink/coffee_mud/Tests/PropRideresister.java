...
*/
public class PropRideresister extends PropTest
{
	@Override
	public String ID()
	{
		return "PropRideresister";
	}
	...
	public String doTest(final MOB mob, final int metaFlags, final String what, final List<String> commands)
	{
		...
		//mob.tell(("Test:@x2-1: @x1", RideResister.accountForYourself(),what));
		...
		//mob.tell(("Test:@x2-2: @x1", RideResister.accountForYourself(),what));
		if (testResistance(mobs[0]))
		{
			return (("Error#4"));
		}
