...
public class PlanarData extends StdWebMacro
{
	...
	public String runMacro(final HTTPRequest httpReq, final String parm, final HTTPResponse httpResp)
	{
		...
		{
			final Map<String,String> planarData = planeSet.getPlanarVars(last);
			if(planarData != null)
			{
				for(final PlanarAbility.PlanarVar var : PlanarAbility.PlanarVar.values())
				{
					if(parms.containsKey(var.toString())
					&&(planarData.containsKey(var.toString())))
					{
						final String val=planarData.get(var.toString());
