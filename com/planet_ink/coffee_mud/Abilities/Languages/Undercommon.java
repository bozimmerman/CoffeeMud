...
public class Undercommon extends StdLanguage
{
	...
	public List<String[]> translationVector(String language)
	{
		if(wordLists==null)
		{
			String[] one={"y","a","e","i","o","á","é","í","ó","i","klpt","ih","g"};
			String[] two={"te","it","at","to","`ai","`oi","`ul","os","vi","ne","vo","li","eh","no","ai","by","et","ce","un","il","te","il","ag","go"};
			String[] three={"nep","tem","tit","nip","pop","pon","upo","wip","pin","aya","dum","mim","oyo","tum","ána","cil","sar","tan","hel","loa","si'r","hep","yur","nol","hol","qua","éth","nik","rem","tit","nip","pop","pon","ipi","wip","pec"};
