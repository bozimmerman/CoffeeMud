		...
		if(success)
		{
			...
			if(mob.location().okAffect(mob,msg))
			{
				...
				for(int f=0;f<mob.numFollowers();f++)
				{
					...
					{
						FullMsg msg2=new FullMsg(follower,mob.getStartRoom(),this,Affect.MASK_MOVE|Affect.TYP_RECALL,"<S-NAME> is sucked into the vortex created by "+mob.displayName()+"s recall.");
