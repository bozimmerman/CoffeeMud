...
public class Skill_Shuffle extends StdAbility
{
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto)
	{
		...
		if(success)
		{
			...
			FullMsg msg2=new FullMsg(mob,null,this,Affect.MSG_THIEF_ACT|(auto?Affect.MASK_GENERAL:0),null);
			...
			return maliciousFizzle(mob,null,"<S-NAME> shuffle(s) around, confusing <S-HIM-HERSELF>.");
