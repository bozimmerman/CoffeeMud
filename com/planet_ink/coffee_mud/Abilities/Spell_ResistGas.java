	...
	implements AbjurationDevotion
{
	...
	public void affect(Affect affect)
	{
		...
		if(affect.amITarget(mob))
		{
			...
			case Affect.STRIKE_GAS:
				...
				{
					mob.location().show(mob,null,Affect.VISUAL_WNOISE,"The filtering field around <S-NAME> absorbs the gas.");
	...
	public boolean invoke(MOB mob, Vector commands)
	{
		...
		FullMsg msg=new FullMsg(mob,target,this,Affect.SOUND_MAGIC,Affect.SOUND_MAGIC,Affect.VISUAL_WNOISE,"<S-NAME> invoke(s) a filtering field of protection around <T-NAME>.");
		if(mob.location().okAffect(msg))
		{
			...
			beneficialFizzle(mob,target,"<S-NAME> attempt(s) to invoke a filtering shield, but fail(s).");
