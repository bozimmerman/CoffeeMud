...
public class Spell_ResistGas extends Spell
{
	...
	private final static String localizedName = CMLib.lang()._("Resist Gas");
	@Override public String name() { return localizedName; }
	private final static String localizedStaticDisplay = CMLib.lang()._("(Resist Gas)");
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			final CMMsg msg=CMClass.getMsg(mob,target,this,verbalCastCode(mob,target,auto),auto?_("<T-NAME> feel(s) filteringly protected."):_("^S<S-NAME> invoke(s) a filtering field of protection around <T-NAMESELF>.^?"));
