...
/*
   Copyright 2003-2026 Bo Zimmerman
...
public void affectPhyStats(final Physical affected, final PhyStats affectableStats)
	...
	public boolean invoke(final MOB mob, final List<String> commands, final Physical givenTarget, final boolean auto, final int asLevel)
	{
		...
		if(success)
		{
			final CMMsg msg=CMClass.getMsg(mob,target,this,somaticCastCode(mob,target,auto),L("^S<S-NAME> incant(s) at <T-NAMESELF> and geyser of water blasts towards <T-HIM-HER>.^?"));
			...
			if((mob.location().okMessage(mob,msg))&&(mob.location().okMessage(mob,msg2)))
			{
				...
				if(percentage < 10)
				{
	  				final CMMsg msg3=CMClass.getMsg(mob,target,this,somaticCastCode(mob,target,auto),L("<T-NAME> is knocked down by the water cannon."));
