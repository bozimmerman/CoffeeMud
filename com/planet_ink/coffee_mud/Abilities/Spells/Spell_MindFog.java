...
public class Spell_MindFog extends Spell
{
	...
	@Override public String name(){return "Mind Fog";}
	@Override public String displayText(){return "(Mind Fog)";}
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			...
			// what happened.
			invoker=mob;
			final CMMsg msg=CMClass.getMsg(mob,target,this,verbalCastCode(mob,target,auto),auto?"":"^S<S-NAME> invoke(s) a spell at <T-NAMESELF>.^?");
