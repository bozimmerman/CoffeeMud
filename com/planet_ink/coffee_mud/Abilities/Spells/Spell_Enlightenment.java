...
public class Spell_Enlightenment extends Spell
{
	...
	public Environmental newInstance(){ return new Spell_Enlightenment();}
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto)
	{
		...
		if(success)
		{
			...
			// what happened.
			FullMsg msg=new FullMsg(mob,target,this,affectType(auto),auto?"":"^S<S-NAME> educates(s) <T-NAMESELF>.^?");
