...
public class Spell_Sonar extends Spell
{
	...
	public void unInvoke()
	{
		...
		super.unInvoke();
		if(canBeUninvoked())
			mob.tell(mob,null,"Your sonar ears return to normal.");
	}
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto)
	{
		...
		if(success)
		{
			FullMsg msg=new FullMsg(mob,null,this,affectType(auto),auto?"<S-NAME> gain(s) <S-HIS-HER> sonar capability!":"^S<S-NAME> incant(s) softly, and <S-HIS-HER> ears become capable of sonar!^?");
