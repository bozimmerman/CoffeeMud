...
public class Spell_ResistCold extends Spell
{
	...
	@Override public String name(){return "Resist Cold";}
	@Override public String displayText(){return "(Resist Cold)";}
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			final CMMsg msg=CMClass.getMsg(mob,target,this,verbalCastCode(mob,target,auto),auto?"<T-NAME> feel(s) warmly protected.":"^S<S-NAME> invoke(s) a warm field of protection around <T-NAMESELF>.^?");
