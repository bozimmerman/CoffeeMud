...
public class Spell_ResistCold extends Spell
{
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			CMMsg msg=CMClass.getMsg(mob,target,this,affectType(auto),auto?"<T-NAME> feel(s) warmly protected.":"^S<S-NAME> invoke(s) a warm field of protection around <T-NAMESELF>.^?");
