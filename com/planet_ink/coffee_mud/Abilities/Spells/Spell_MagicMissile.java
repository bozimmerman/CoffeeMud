...
public class Spell_MagicMissile extends Spell
{
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			...
			{
				CMMsg msg=CMClass.getMsg(mob,target,this,verbalCastCode(mob,target,auto),(i==0)?((auto?"A magic missile appears hurling full speed at <T-NAME>!":"^S<S-NAME> point(s) at <T-NAMESELF>, shooting forth a magic missile!^?")+CMProps.msp("spelldam2.wav",40)):null);
