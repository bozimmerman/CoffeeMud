...
public class Spell_ResistBludgeoning extends Spell
{
	...
	@Override public String name(){return "Resist Bludgeoning";}
	@Override public String displayText(){return "(Resist Bludgeoning)";}
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			final CMMsg msg=CMClass.getMsg(mob,target,this,verbalCastCode(mob,target,auto),auto?"<T-NAME> feel(s) protected.":"^S<S-NAME> invoke(s) an anti-bludgeoning barrier around <T-NAMESELF>.^?");
