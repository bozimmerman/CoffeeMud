...
public class Spell_Blindness extends Spell
{
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			...
			// what happened.
			invoker=mob;
			CMMsg msg=CMClass.getMsg(mob,target,this,affectType(auto),auto?"":"^SYou invoke a flashing light into <T-NAME>s eyes.^?",affectType(auto),auto?"":"^S<S-NAME> invoke(s) a flashing light into your eyes.^?",CMMsg.MSG_CAST_ATTACK_VERBAL_SPELL,auto?"":"^S<S-NAME> invokes a flashing light into <T-NAME>s eyes.^?");
