...
public class Spell_AcidArrow extends Spell
{
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto)
	{
		...
		if(success)
		{
			...
			// what happened.
			FullMsg msg=new FullMsg(mob,target,this,affectType,auto?"An arrow made of acid appears zooming towards <T-NAME>!":"<S-NAME> point(s) at <T-NAMESELF>, conjuring an acid arrow from the java plain!");
			...
			if((mob.location().okAffect(msg))&&((mob.location().okAffect(msg2))))
			{
				...
				if(!msg.wasModified())
				{
					...
					ExternalPlay.postDamage(mob,target,this,damage,Affect.ACT_GENERAL|Affect.TYP_ACID,Weapon.TYPE_BURNING,"The acidic blast <DAMAGE> <T-NAME>!");
