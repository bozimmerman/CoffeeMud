...
public class Spell_ResistPetrification extends Spell
{
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			CMMsg msg=CMClass.getMsg(mob,target,this,affectType(auto),auto?"<T-NAME> feel(s) flowingly protected.":"^S<S-NAME> invoke(s) a flowing barrier of protection around <T-NAMESELF>.^?");
