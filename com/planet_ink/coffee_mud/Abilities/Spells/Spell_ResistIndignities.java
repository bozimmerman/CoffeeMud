...
public class Spell_ResistIndignities extends Spell
{
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			CMMsg msg=CMClass.getMsg(mob,target,this,verbalCastCode(mob,target,auto),auto?"<T-NAME> feel(s) well protected.":"^S<S-NAME> invoke(s) a dignified field of protection around <T-NAMESELF>.^?");
