...
public class Spell_ResistElectricity extends Spell
{
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			CMMsg msg=CMClass.getMsg(mob,target,this,affectType(auto),auto?"<T-NAME> feel(s) organically protected.":"^S<S-NAME> invoke(s) a shimmering organic field of protection around <T-NAMESELF>.^?");
