...
public class Spell_ResistElectricity extends Spell
{
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto)
	{
		...
		if(success)
		{
			FullMsg msg=new FullMsg(mob,target,this,affectType(auto),auto?"<S-NAME> feel(s) organically protected.":"^S<S-NAME> invoke(s) a shimmering organic field of protection around <T-NAMESELF>.^?");
