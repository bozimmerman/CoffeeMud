...
public class Spell_ResistElectricity extends Spell
{
	...
	@Override public String name(){return "Resist Electricity";}
	@Override public String displayText(){return "(Resist Electricity)";}
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			final CMMsg msg=CMClass.getMsg(mob,target,this,verbalCastCode(mob,target,auto),auto?"<T-NAME> feel(s) organically protected.":"^S<S-NAME> invoke(s) a shimmering organic field of protection around <T-NAMESELF>.^?");
