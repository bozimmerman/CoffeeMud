...
public class Spell_Anchor extends Spell
{
	...
	public boolean okMessage(Environmental myHost, CMMsg msg)
	{
		...
		&&((affected==null)
			||((affected instanceof Item)&&(!((Item)affected).amWearingAt(Item.IN_INVENTORY))&&(msg.amITarget(((Item)affected).owner())))
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			CMMsg msg=CMClass.getMsg(mob,target,this,affectType(auto),(auto?"An magical anchoring field envelopes <T-NAME>!":"^S<S-NAME> invoke(s) an anchoring field of protection around <T-NAMESELF>.^?"));
