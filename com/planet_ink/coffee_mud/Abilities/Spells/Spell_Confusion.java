...
public class Spell_Confusion extends Spell
{
	...
	@Override public String name(){return "Confusion";}
	@Override public String displayText(){return "(Confusion spell)";}
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			...
			// what happened.
			invoker=mob;
			final CMMsg msg=CMClass.getMsg(mob,target,this,verbalCastCode(mob,target,auto),auto?"":"^S<S-NAME> enchant(s) <T-NAMESELF>!^?");
