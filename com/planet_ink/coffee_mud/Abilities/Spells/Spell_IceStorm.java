		...
		if(success)
		{
			...
			for(Iterator f=h.iterator();f.hasNext();)
			{
				...
				if((mob.location().okMessage(mob,msg))&&((mob.location().okMessage(mob,msg2))))
				{
					...
					MUDFight.postDamage(mob,target,this,damage,CMMsg.MASK_GENERAL|CMMsg.TYP_COLD,Weapon.TYPE_FROSTING,"The lumps of hail <DAMAGE> <T-NAME>!"+CommonStrings.msp("hail.wav",40));
				}
			}
		}
		else
