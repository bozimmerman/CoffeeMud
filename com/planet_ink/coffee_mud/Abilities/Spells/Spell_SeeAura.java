...
public class Spell_SeeAura extends Spell
{
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto)
	{
		...
		// what happened.
		FullMsg msg=new FullMsg(mob,target,this,affectType,auto?"":"You draw out <T-NAME>s aura.",affectType,auto?"":"<S-NAME> draw(s) out your aura.",affectType,auto?"":"<S-NAME> draws out <T-NAME>s aura.");
		if(success)
		{
			...
			beneficialVisualFizzle(mob,target,"<S-NAME> examine(s) <T-NAME>, chanting, but the spell fizzles.");
