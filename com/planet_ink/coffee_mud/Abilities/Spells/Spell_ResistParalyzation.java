...
public class Spell_ResistParalyzation extends Spell
{
	...
	public Environmental newInstance(){	return new Spell_ResistParalyzation();}
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto)
	{
		...
		if(success)
		{
			FullMsg msg=new FullMsg(mob,target,this,affectType(auto),auto?"<S-NAME> feel(s) liberatingly protected.":"^S<S-NAME> invoke(s) a liberating field of protection around <T-NAMESELF>.^?");
