...
public class Spell_ResistParalyzation extends Spell
{
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			CMMsg msg=CMClass.getMsg(mob,target,this,affectType(auto),auto?"<T-NAME> feel(s) liberatingly protected.":"^S<S-NAME> invoke(s) a liberating field of protection around <T-NAMESELF>.^?");
