	...
	implements IllusionistDevotion
{
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto)
	{
		...
		{
			FullMsg msg=new FullMsg(mob,target,this,affectType,auto?"":"<S-NAME> fizzles a spell, since "+mob.charStats().heshe()+" is affected by that spell.");
		...
		if(success)
		{
			...
			return beneficialWordsFizzle(mob,target,"<S-NAME> whispers(s) to <S-HIS-HER>self, but nothing happens.");
