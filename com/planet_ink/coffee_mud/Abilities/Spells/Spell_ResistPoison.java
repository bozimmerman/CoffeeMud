...
public class Spell_ResistPoison extends Spell
{
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			CMMsg msg=CMClass.getMsg(mob,target,this,affectType(auto),auto?"<T-NAME> feel(s) well protected.":"^S<S-NAME> invoke(s) an anti-venom field of protection around <T-NAMESELF>.^?");
