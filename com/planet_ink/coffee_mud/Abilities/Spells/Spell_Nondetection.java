...
public class Spell_Nondetection extends Spell
{
	...
	public final static String localizedName = CMLib.lang()._("Resist Divination");
	@Override public String name() { return localizedName; }
	@Override public String displayText(){return "(Resist Divination)";}
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			final CMMsg msg=CMClass.getMsg(mob,target,this,verbalCastCode(mob,target,auto),(auto?"An undetectable field envelopes <T-NAME>!":"^S<S-NAME> invoke(s) an globe of resistance around <T-NAMESELF>.^?"));
