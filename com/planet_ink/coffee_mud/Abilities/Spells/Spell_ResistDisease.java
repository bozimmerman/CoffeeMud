...
public class Spell_ResistDisease extends Spell
{
	...
	@Override public String name(){return "Resist Disease";}
	@Override public String displayText(){return "(Resist Disease)";}
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			final CMMsg msg=CMClass.getMsg(mob,target,this,verbalCastCode(mob,target,auto),auto?"<T-NAME> feel(s) immunizingly protected.":"^S<S-NAME> invoke(s) an immunizing field of protection around <T-NAMESELF>.^?");
