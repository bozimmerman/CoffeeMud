...
public class Trap_AcidSpray extends StdTrap
{
	...
	public void spring(MOB target)
	{
		if((target!=invoker())&&(target.location()!=null))
		{
			...
			{
				super.spring(target);
				CMLib.combat().postDamage(invoker(),target,null,CMLib.dice().roll(trapLevel(),6,1),CMMsg.MASK_GENERAL|CMMsg.TYP_ACID,Weapon.TYPE_MELTING,"The acid <DAMAGE> <T-NAME>!");
