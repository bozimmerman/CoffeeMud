...
public class Bomb_FlameBurst extends StdBomb
{
	...
	public void spring(MOB target)
	{
		if(target.location()!=null)
		{
			...
			{
				super.spring(target);
				CMLib.combat().postDamage(invoker(),target,null,CMLib.dice().roll(trapLevel(),12,1),CMMsg.MASK_GENERAL|CMMsg.TYP_FIRE,Weapon.TYPE_BURNING,"The flames <DAMAGE> <T-NAME>!");
			}
		}
	}
