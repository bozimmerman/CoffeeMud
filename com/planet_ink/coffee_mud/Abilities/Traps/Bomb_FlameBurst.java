...
public class Bomb_FlameBurst extends StdBomb
{
	...
	public void spring(MOB target)
	{
		if(target.location()!=null)
		{
			...
			if(target.location().show(invoker(),target,this,Affect.MASK_GENERAL|Affect.MSG_NOISE,(affected.name()+" flames all over <T-NAME>!")+CommonStrings.msp("fireball.wav",30)))
			{
				super.spring(target);
