				...
				if(tickDown>4)
				{
					for(int i=0;i<R.numInhabitants();i++)
					{
						...
						if((M!=null)&&(M!=invoker()))
							...
							{
								int damage=CMLib.dice().roll(trapLevel(),30,1);
								CMLib.combat().postDamage(invoker(),M,this,damage,CMMsg.MASK_MALICIOUS|CMMsg.MSG_OK_ACTION,Weapon.TYPE_BASHING,"The crushing walls <DAMAGE> <T-NAME>!");
							}
					}
				}
				else
