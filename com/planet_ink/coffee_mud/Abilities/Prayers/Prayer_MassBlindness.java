		...
		if(success)
		{
			for(Iterator e=h.iterator();e.hasNext();)
			{
				...
				if(auto||(target.charStats().getBodyPart(Race.BODY_EYE)>0))
				{
					...
					// what happened.
					CMMsg msg=CMClass.getMsg(mob,target,this,somanticCastCode(mob,target,auto)|CMMsg.MASK_MALICIOUS,auto?"":"^S<S-NAME> "+prayForWord(mob)+" an unholy blindness upon <T-NAMESELF>.^?");
