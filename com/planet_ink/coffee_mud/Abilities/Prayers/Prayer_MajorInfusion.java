...
public class Prayer_MajorInfusion extends Prayer implements MendingSkill
{
	...
	private final static String localizedName = CMLib.lang()._("Major Infusion");
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			...
			// what happened.
			final CMMsg msg=CMClass.getMsg(mob,target,this,verbalCastCode(mob,target,auto),auto?_("A soft yellow glow surrounds <T-NAME>."):_("^S<S-NAME> @x1, delivering a strong touch of infusion to <T-NAMESELF>.^?",prayWord(mob)));
