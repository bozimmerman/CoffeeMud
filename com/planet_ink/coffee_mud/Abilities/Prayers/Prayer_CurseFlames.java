	...
	public boolean invoke(final MOB mob, final List<String> commands, final Physical givenTarget, final boolean auto, final int asLevel)
	{
		...
		if((success)&&(fireSource!=null))
		{
			final CMMsg msg=CMClass.getMsg(mob,target,this,verbalCastCode(mob,target,auto),
					(auto?L("Suddenly @x1 flares up and attacks <T-HIM-HER>!^?",fireSource.Name()):
						L("^S<S-NAME> point(s) at <T-NAMESELF> and @x2.  Suddenly @x1 flares up and attacks <T-HIM-HER>!^?",fireSource.Name(),prayWord(mob)))
