				   ...
				   &&(source.getAlignment()>350))
				{
					...
					if(source.location().okMessage(source,msg2))
					{
						...
						if(msg2.value()<=0)
						{
							...
							MUDFight.postDamage(mob,source,this,damage,CMMsg.MASK_GENERAL|CMMsg.TYP_FIRE,Weapon.TYPE_BURNING,"The unholy flames around <S-NAME> flare and <DAMAGE> <T-NAME>!");
						}
					}
				}
			}
