...
public class Prayer_Regeneration extends Prayer
{
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto)
	{
		...
		if(success)
		{
			...
			// what happened.
			FullMsg msg=new FullMsg(mob,target,this,affectType,auto?"<T-NAME> attain(s) regenerative abilities!":"<S-NAME> pray(s) for divine regenerative abilities!");
			...
			return beneficialWordsFizzle(mob,target,"<S-NAME> pray(s) for regenerative abilities, but nothing happens.");
