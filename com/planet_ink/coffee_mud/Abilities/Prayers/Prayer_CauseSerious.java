...
public class Prayer_CauseSerious extends Prayer
{
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			...
			// what happened.
			CMMsg msg=CMClass.getMsg(mob,target,this,(undead?0:CMMsg.MASK_MALICIOUS)|affectType(auto),(auto?"A seriously painful burst assaults <T-NAME>.":"^S<S-NAME> "+prayWord(mob)+" for a serious burst of pain at <T-NAMESELF>!^?")+CMProps.msp("spelldam1.wav",40));
			if(mob.location().okMessage(mob,msg))
			{
				...
				if(msg.value()<=0)
				{
					...
					CMLib.combat().postDamage(mob,target,this,harming,CMMsg.MASK_GENERAL|CMMsg.TYP_UNDEAD,Weapon.TYPE_BURSTING,"The unholy spell <DAMAGE> <T-NAME>!");
				}
			}
		}
		else
