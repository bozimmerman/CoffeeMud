...
public class Prayer_PreserveBody extends Prayer
{
	...
	@Override public String name(){ return "Preserve Body";}
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			final CMMsg msg=CMClass.getMsg(mob,target,this,verbalCastCode(mob,target,auto),auto?"":"^S<S-NAME> "+prayForWord(mob)+" to preserve <T-NAMESELF>.^?");
