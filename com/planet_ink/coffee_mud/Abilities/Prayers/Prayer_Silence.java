...
public class Prayer_Silence extends Prayer
{
	...
	@Override public String displayText(){ return "(Silenced)";}
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			...
			// what happened.
			final CMMsg msg=CMClass.getMsg(mob,target,this,verbalCastCode(mob,target,auto),auto?"":"^S<S-NAME> "+prayWord(mob)+" for an unholy silence upon <T-NAMESELF>.^?");
