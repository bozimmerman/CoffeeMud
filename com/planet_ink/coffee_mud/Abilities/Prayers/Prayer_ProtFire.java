...
public class Prayer_ProtFire extends Prayer
{
	...
	@Override public String name(){ return "Protection Fire";}
	@Override public String displayText(){return "(Protection from Fire)";}
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			final CMMsg msg=CMClass.getMsg(mob,target,this,verbalCastCode(mob,target,auto),auto?"A cool field of protection appears around <T-NAME>.":"^S<S-NAME> "+prayWord(mob)+" for a cool field of protection around <T-NAMESELF>.^?");
