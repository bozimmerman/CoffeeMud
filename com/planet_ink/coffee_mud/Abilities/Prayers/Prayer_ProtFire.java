...
public class Prayer_ProtFire extends Prayer
{
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			CMMsg msg=CMClass.getMsg(mob,target,this,affectType(auto),auto?"A cool field of protection appears around <T-NAME>.":"^S<S-NAME> "+prayWord(mob)+" for a cool field of protection around <T-NAMESELF>.^?");
