...
public class Prayer_MinorInfusion extends Prayer
{
    ...
    public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto, int asLevel)
    {
        ...
        if(success)
        {
            ...
            // what happened.
            CMMsg msg=CMClass.getMsg(mob,target,this,somanticCastCode(mob,target,auto),auto?"A soft yellow glow surrounds <T-NAME>.":"^S<S-NAME> "+prayWord(mob)+", delivering a light touch of infusion to <T-NAMESELF>.^?");
