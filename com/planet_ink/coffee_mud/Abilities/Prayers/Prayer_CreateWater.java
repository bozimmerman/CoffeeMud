...
public class Prayer_CreateWater extends Prayer
{
	...
	@Override public String unlocalizedName(){ return "Create Water";}
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			final CMMsg msg=CMClass.getMsg(mob,target,this,verbalCastCode(mob,target,auto),auto?"":_("^S<S-NAME> @x1 over <T-NAME> for water.^?",prayWord(mob)));
