...
{
	public String ID() { return "Prayer_AcidHealing"; }
	public String name(){ return "Acid Healing";}
	public String displayText(){ return "(Acid Healing)";}
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			...
			// what happened.
			CMMsg msg=CMClass.getMsg(mob,target,this,somanticCastCode(mob,target,auto),auto?"":"^S<S-NAME> "+prayWord(mob)+" for acidic healing.^?");
			...
			return beneficialWordsFizzle(mob,target,"<S-NAME> "+prayWord(mob)+" for acidic healing, but <S-HIS-HER> plea is not answered.");
