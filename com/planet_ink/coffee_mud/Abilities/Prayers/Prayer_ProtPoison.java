...
public class Prayer_ProtPoison extends Prayer
{
	...
	@Override public String name(){ return "Protection Poison";}
	@Override public String displayText(){ return "(Protection/Poison)";}
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			...
			// what happened.
			final CMMsg msg=CMClass.getMsg(mob,target,this,verbalCastCode(mob,target,auto),auto?"<T-NAME> attain(s) a anitidotal protection.":"^S<S-NAME> "+prayWord(mob)+" for protection from poisons.^?");
