...
public class Prayer_ProtectHealth extends Prayer
{
	...
	public boolean okAffect(Affect affect)
	{
		...
		{
			if((affect.targetMinor()==Affect.TYP_MIND)
			...
			{
				affect.source().location().show(invoker,null,Affect.MSG_OK_VISUAL,"The holy field around <S-NAME> protect(s) <S-HIS-HER> body from unhealthy assaults.");
				return false;
			}
