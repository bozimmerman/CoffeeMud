...
public class Prayer_Marry extends Prayer
{
	...
	private final static String localizedName = CMLib.lang()._("Marry");
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			final CMMsg msg=CMClass.getMsg(mob,null,this,verbalCastCode(mob,null,auto),auto?"":_("^S<S-NAME> @x1 to bless the holy union between @x2 and @x3.^?",prayForWord(mob),husband.name(),wife.name()));
			if(mob.location().okMessage(mob,msg))
			{
				...
				CMLib.commands().postSay(mob,husband,_("You may kiss your bride!"),false,false);
