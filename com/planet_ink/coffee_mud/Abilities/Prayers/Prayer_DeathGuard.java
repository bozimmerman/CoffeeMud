...
{
	@Override public String ID() { return "Prayer_DeathGuard"; }
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			...
			return beneficialWordsFizzle(mob,target,L("<S-NAME> @x1 for a a death guard over <T-YOUPOSS>, but there is no answer.",prayWord(mob)));
