...
public class Prayer_CureLight extends Prayer
{
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			...
			// what happened.
			CMMsg msg=CMClass.getMsg(mob,target,this,(!undead?0:CMMsg.MASK_MALICIOUS)|affectType(auto),auto?"A faint white glow surrounds <T-NAME>.":"^S<S-NAME> "+prayWord(mob)+", delivering a light healing touch to <T-NAMESELF>.^?");
