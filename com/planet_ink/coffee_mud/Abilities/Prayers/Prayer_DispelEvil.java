...
public class Prayer_DispelEvil extends Prayer
{
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto)
	{
		...
		if((success)&&(target.getAlignment()<350))
		{
			...
			FullMsg msg=new FullMsg(mob,target,newOne,affectType|Affect.MASK_MALICIOUS,auto?"The evil inside <T-NAME> exercise(s)!":"<S-NAME> exercise(s) the evil inside <T-NAMESELF>!");
