...
public class Prayer_Earthshield extends Prayer
{
	...
	public void affectEnvStats(Environmental affected, EnvStats affectableStats)
	{
		...
		affectableStats.setArmor(affectableStats.armor()-(2*CMLib.ableMapper().qualifyingClassLevel((MOB)affected,this)));
	}
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			...
			// what happened.
			CMMsg msg=CMClass.getMsg(mob,target,this,somanticCastCode(mob,target,auto),auto?"":"^S<S-NAME> "+prayWord(mob)+".^?");
