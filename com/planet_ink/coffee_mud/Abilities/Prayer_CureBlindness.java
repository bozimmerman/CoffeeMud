...
public class Prayer_CureBlindness extends Prayer
{
	...
	public Vector returnOffensiveAffects(MOB caster, Environmental fromMe)
	{
		...
		FullMsg msg=new FullMsg(newMOB,null,null,Affect.VISUAL_LOOK,"blah",Affect.VISUAL_LOOK,"blah",Affect.VISUAL_LOOK,"blah");
	...
	public boolean invoke(MOB mob, Vector commands)
	{
		...
		if((success)&&(offensiveAffects.size()>0))
		{
			...
			// what happened.
			FullMsg msg=new FullMsg(mob,target,this,Affect.SOUND_MAGIC,Affect.SOUND_MAGIC,Affect.SOUND_MAGIC,"<S-NAME> pray(s) for <T-NAME> to see the light.");
