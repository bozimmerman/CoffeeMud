...
public class Chant_UnicornsHealth extends Chant
{
	...
	public void affectCharStats(MOB affected, CharStats affectableStats)
	{
		...
		affectableStats.setStat(CharStats.CONSTITUTION,affectableStats.getStat(CharStats.CONSTITUTION)+(affected.envStats().level()/6));
	}
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto)
	{
		...
		{
			mob.tell("You already have the health of a unicorn.");
			return false;
		}
		...
		if(success)
		{
			...
			// what happened.
			invoker=mob;
			FullMsg msg=new FullMsg(mob,target,this,affectType(auto),auto?"<S-NAME> gain(s) the health of a unicorn!":"^S<S-NAME> chant(s), feeling the health of a unicorn!^?");
