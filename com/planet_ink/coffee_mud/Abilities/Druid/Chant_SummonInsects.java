...
public class Chant_SummonInsects extends Chant
{
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto)
	{
		...
		if(success)
		{
			if(h==null)
			{
				mob.location().show(mob,null,affectType,auto?"A swarm of stinging insects appear, then flutter away!":"<S-NAME> chant(s) into the sky.  A swarm of stinging insects appear.  Finding noone to sting, they flutter away.");
				return false;
			}
			mob.location().show(mob,null,affectType,auto?"A swarm of stinging insects appear, then flutter away!":"<S-NAME> chant(s) into the sky.  A swarm of stinging insects appears and attacks!");
