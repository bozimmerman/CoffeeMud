...
public class Chant_ColdMoon extends Chant
{
	...
	public Environmental newInstance(){	return new Chant_ColdMoon();}
	...
	public void unInvoke()
	{
		...
		if((affected==null)||(!(affected instanceof MOB)))
		{
			if(affected instanceof Room)
				((Room)affected).showHappens(Affect.MSG_OK_VISUAL,"The cold moon sets.");
			super.unInvoke();
			return;
		}
	...
	public void affectCharStats(MOB affected, CharStats affectableStats)
	{
		...
		affectableStats.setStat(CharStats.SAVE_DISEASE,affectableStats.getStat(CharStats.SAVE_DISEASE)-50);
	}
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto)
	{
		...
		if(success)
		{
			...
			if(mob.location().okAffect(mob,msg))
			{
				...
				if(!msg.wasModified())
				{
					mob.location().showHappens(Affect.MSG_OK_VISUAL,"The Cold Moon Rises!");
