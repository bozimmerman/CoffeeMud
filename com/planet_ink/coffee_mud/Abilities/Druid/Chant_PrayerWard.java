...
public class Chant_PrayerWard extends Chant
{
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			CMMsg msg=CMClass.getMsg(mob,target,this,affectType(auto),auto?"<T-NAME> <T-IS-ARE> protected from prayers.":"^S<S-NAME> chant(s) for a ward against prayers around <T-NAMESELF>.^?");
