...
public class Chant_GasWard extends Chant
{
	...
	@Override public String name(){ return "Gas Ward";}
	@Override public String displayText(){return "(Gas Ward)";}
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			final CMMsg msg=CMClass.getMsg(mob,target,this,verbalCastCode(mob,target,auto),auto?"A filtering field of protection appears around <T-NAME>.":"^S<S-NAME> chant(s) for a filtering field of protection around <T-NAMESELF>.^?");
