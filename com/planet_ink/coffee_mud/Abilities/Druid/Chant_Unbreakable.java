...
public class Chant_Unbreakable extends Chant
{
	...
	@Override public String name(){ return "Unbreakable";}
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			...
			// what happened.
			final CMMsg msg=CMClass.getMsg(mob,target,this,verbalCastCode(mob,target,auto),auto?"<T-NAME> appear(s) unbreakable!":"^S<S-NAME> chant(s) to <T-NAMESELF>.^?");
