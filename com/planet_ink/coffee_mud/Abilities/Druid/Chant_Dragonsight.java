...
public class Chant_Dragonsight extends Chant
{
    ...
    public void affectCharStats(MOB affected, CharStats affectableStats)
    {
        ...
        affectableStats.setStat(CharStats.SAVE_OVERLOOKING,affected.envStats().level()+50+affectableStats.getStat(CharStats.SAVE_OVERLOOKING));
    }
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			...
			// what happened.
			invoker=mob;
			FullMsg msg=new FullMsg(mob,target,this,affectType(auto),auto?"<S-NAME> gain(s) the dragonsight!":"^S<S-NAME> chant(s) for the dragonsight!^?");
