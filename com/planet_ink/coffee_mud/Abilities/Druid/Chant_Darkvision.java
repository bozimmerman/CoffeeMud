...
public class Chant_Darkvision extends Chant
{
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto)
	{
		...
		{
			target.tell("You already have darkvision.");
			return false;
		}
		...
		if(success)
		{
			...
			// what happened.
			invoker=mob;
			FullMsg msg=new FullMsg(mob,target,this,affectType(auto),auto?"<S-NAME> gain(s) darkvision!":"^S<S-NAME> chant(s) for darkvision!^?");
