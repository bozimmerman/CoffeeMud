...
public class Chant_AcidRain extends Chant
{
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto)
	{
		...
		if(success)
		{
			...
			// what happened.
			invoker=mob;
			FullMsg msg=new FullMsg(mob,null,this,affectType(auto),auto?"":"^S<S-NAME> chant(s) to the sky.^?");
			...
			return maliciousFizzle(mob,target,"<S-NAME> chant(s) the sky, but the magic fades.");
