		...
		if(affected instanceof Room)
		{
			...
			for(int i=0;i<room.numInhabitants();i++)
			{
				...
				if((M!=null)&&(M!=invoker))
				{
					...
					CMLib.combat().postDamage(invoker,M,this,CMLib.dice().roll(1,M.phyStats().level()+(2*super.getXLEVELLevel(invoker())),0),CMMsg.MASK_ALWAYS|CMMsg.TYP_UNDEAD,Weapon.TYPE_BURSTING,L("The gaze of the death moon <DAMAGE> <T-NAME>!"));
