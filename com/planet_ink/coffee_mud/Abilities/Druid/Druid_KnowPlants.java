...
public class Druid_KnowPlants extends StdAbility
{
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto)
	{
		...
		{
			mob.tell("Your plant knowledge can tell you nothing about "+I.displayName()+".");
			return false;
		}
		...
		else
		{
			...
			if(mob.location().okAffect(mob,msg))
			{
				...
				str.append(I.displayName()+" is a kind of "+EnvResource.RESOURCE_DESCS[I.material()&EnvResource.RESOURCE_MASK].toLowerCase()+".  ");
				if(isPlant(I))
