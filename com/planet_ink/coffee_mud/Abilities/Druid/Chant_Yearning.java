...
public class Chant_Yearning extends Chant
{
	...
	public void executeMsg(Environmental myHost, CMMsg msg)
	{
		...
		&&(((MOB)msg.target()).numWearingHere(Item.WORN_LEGS)==0)
		&&(myChar.numWearingHere(Item.WORN_WAIST)==0)
		&&(((MOB)msg.target()).numWearingHere(Item.WORN_WAIST)==0))
			unInvoke();
	}
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			...
			// what happened.
			CMMsg msg=CMClass.getMsg(mob,target,this,affectType(auto)|CMMsg.MASK_MALICIOUS,auto?"":"^S<S-NAME> chant(s) to <T-NAMESELF>.^?");
