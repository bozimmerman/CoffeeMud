...
public class Chant_FireWard extends Chant
{
	...
	@Override public String name(){ return "Fire Ward";}
	@Override public String displayText(){return "(Fire Ward)";}
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			final CMMsg msg=CMClass.getMsg(mob,target,this,verbalCastCode(mob,target,auto),auto?"A cool field of protection appears around <T-NAME>.":"^S<S-NAME> chant(s) for a cool field of protection around <T-NAMESELF>.^?");
