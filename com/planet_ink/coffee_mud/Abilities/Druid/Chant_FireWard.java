...
public class Chant_FireWard extends Chant
{
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			FullMsg msg=new FullMsg(mob,target,this,affectType(auto),auto?"A cool field of protection appears around <T-NAME>.":"^S<S-NAME> chant(s) for a cool field of protection around <T-NAMESELF>.^?");
