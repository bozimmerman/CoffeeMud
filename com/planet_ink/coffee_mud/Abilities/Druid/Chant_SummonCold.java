...
public class Chant_SummonCold extends Chant
{
	...
	@Override public String unlocalizedName(){ return "Summon Cold";}
	...
	public boolean invoke(MOB mob, Vector commands, Physical givenTarget, boolean auto, int asLevel)
	{
		...
		if(success)
		{
			final CMMsg msg=CMClass.getMsg(mob,null,this,verbalCastCode(mob,null,auto),auto?_("^JThe sky changes color!^?"):_("^S<S-NAME> chant(s) into the sky for cold!^?"));
