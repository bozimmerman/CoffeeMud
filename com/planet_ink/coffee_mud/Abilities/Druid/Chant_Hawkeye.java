...
public class Chant_Hawkeye extends Chant
{
	...
	public Environmental newInstance(){ return new Chant_Hawkeye();}
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto)
	{
		...
		if(success)
		{
			...
			// what happened.
			invoker=mob;
			FullMsg msg=new FullMsg(mob,target,this,affectType(auto),auto?"<S-NAME> gain(s) hawk(s) eyes!":"^S<S-NAME> chant(s) for hawk's eyes!^?");
