	...
	public boolean tick(Tickable ticking, int tickID)
	{
		if((affected!=null)&&(affected instanceof Room))
		{
			...
			for(int i=0;i<R.numInhabitants();i++)
			{
                ...
                {
					CMLib.combat().postDamage(invoker(),M,this,CMLib.dice().roll(1,M.envStats().level(),1),CMMsg.MASK_ALWAYS|CMMsg.TYP_FIRE,Weapon.TYPE_MELTING,"The extreme heat <DAMAGE> <T-NAME>!");
