...
public class Prayer_SenseMagic extends Prayer
{
	...
	public boolean invoke(MOB mob, Vector commands)
	{
		...
		if(success)
		{
			...
			// what happened.
			FullMsg msg=new FullMsg(mob,null,this,Affect.SOUND_MAGIC,Affect.SOUND_MAGIC,Affect.SOUND_MAGIC,"<S-NAME> pray(s) for divine revelation, and <S-HIS-HER> eyes begin to sparkle.");
