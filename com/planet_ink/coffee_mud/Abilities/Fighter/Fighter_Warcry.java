...
public class Fighter_Warcry extends StdAbility
{
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto)
	{
		...
		if(success)
		{
			FullMsg msg=new FullMsg(mob,null,this,Affect.MSG_SPEAK,auto?"":"^S<S-NAME> screams(s) a mighty WAR CRY!!^?");
			...
			beneficialWordsFizzle(mob,null,auto?"":"<S-NAME> mumbles(s) a weak war cry.");
