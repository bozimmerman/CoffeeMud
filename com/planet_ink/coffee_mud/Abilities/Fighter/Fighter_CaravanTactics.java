...
*/
public class Fighter_CaravanTactics extends Fighter_FieldTactics
{
	@Override
	public String ID()
	{
		return "Fighter_CaravanTactics";
	}

	private final static String localizedName = CMLib.lang().L("Caravan Tactics");
