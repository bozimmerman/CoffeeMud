...
public class Fighter_Kick extends StdAbility
{
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto)
	{
		...
		if(success)
		{
			...
			FullMsg msg=new FullMsg(mob,target,this,Affect.MSK_MALICIOUS_MOVE|Affect.TYP_JUSTICE,auto?"<T-NAME> get(s) kicked!":"<S-NAME> kick(s) and "+ExternalPlay.hitWord(Weapon.TYPE_BASHING,damage)+" <T-NAMESELF>!");
