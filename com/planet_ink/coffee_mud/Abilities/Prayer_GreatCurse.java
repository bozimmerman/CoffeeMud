...
public class Prayer_GreatCurse extends Prayer
{
	public Prayer_GreatCurse()
	{
		...
		addQualifyingClass(new Archon().ID(),baseEnvStats().level());
	...
	public boolean invoke(MOB mob, Vector commands)
	{
		...
		if(success)
		{
			...
			// what happened.
			FullMsg msg=new FullMsg(mob,target,this,Affect.SOUND_MAGIC,Affect.STRIKE_MAGIC,Affect.SOUND_MAGIC,"<S-NAME> curse(s) <S-HIS-HER> horribly.");
			...
			return maliciousFizzle(mob,target,"<S-NAME> attempt(s) to horribly curse <S-HIS-HER>, but nothing happens.");
