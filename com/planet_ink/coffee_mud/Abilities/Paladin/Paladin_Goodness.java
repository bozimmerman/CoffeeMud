			...
			for(int m=0;m<mob.location().numInhabitants();m++)
			{
					...
					||((target.getVictim()==invoker)&&(target.rangeToTarget()==0))))
				{
					...
					if(target.getAlignment()<350)
						ExternalPlay.postDamage(invoker,target,this,harming,Affect.ACT_EYES|Affect.MASK_MALICIOUS|Affect.TYP_UNDEAD,Weapon.TYPE_BURSTING,"^SThe aura of goodness around <S-NAME> <DAMAGE> <T-NAME>!^?");
				}
			}
		}
		return true;
