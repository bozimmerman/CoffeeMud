...
public class AnimalTrapping extends GatheringSkill
{
	...
	public boolean invoke(final MOB mob, final List<String> commands, final Physical givenTarget, final boolean auto, final int asLevel)
	{
		...
		{
			commonFaiL(mob,commands,"Animal traps have already been set here.");
			return false;
		}
		...
		{
			commonFaiL(mob,commands,"@x1 is not a proper animal cage!",targetI.name(mob));
			return false;
		}
		boolean empty=true;
		...
		if(!empty)
		{
			commonFaiL(mob,commands,"@x1 is not a empty!",targetI.name(mob));
			return false;
		}
		...
		if(targetI.owner() != R)
		{
			commonFaiL(mob,commands,"@x1 is not a working!",targetI.name(mob));
			return false;
		}
