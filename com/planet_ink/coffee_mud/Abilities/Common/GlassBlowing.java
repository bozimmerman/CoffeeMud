...
public class GlassBlowing extends CommonSkill
{
	...
	public void unInvoke()
	{
		if(canBeUninvoked())
		{
			if((affected!=null)&&(affected instanceof MOB))
			{
				...
				{
					if(messedUp)
						commonTell(mob,"A "+building.displayName()+" explodes!");
					else
	...
	public boolean invoke(MOB mob, Vector commands, Environmental givenTarget, boolean auto)
	{
		...
		startStr="<S-NAME> start(s) blowing "+building.displayName()+".";
		displayText="You are blowing "+building.displayName();
		verb="blowing "+building.displayName();
