...
/*
   Copyright 2004-2026 Tim Kassebaum
...
public class Cobbling extends EnhancedCraftingSkill implements ItemCraftor, MendingSkill
{
								 ...
								 final int asLevel, final int autoGenerate, final boolean forceLevels, final List<CraftedItem> crafted)
	{
		...
		if(str.equalsIgnoreCase("refit"))
		{
			...
			{
				commonFaiL(mob,commands,"That's not footwear.  That can't be refitted.");
				return false;
			}
		...
		else
		{
			...
			if(foundRecipe==null)
			{
				commonFaiL(mob,commands,"You don't know how to make a '@x1'.  Try \"cobble list\" for a list.",recipeName);
				return false;
			}
