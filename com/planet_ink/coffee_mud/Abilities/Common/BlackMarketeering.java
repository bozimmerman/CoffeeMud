...
public class BlackMarketeering extends Merchant
{
	...
	private static final String[]	triggerStrings	= I(new String[] { "BLACKMARKET", "BMARKET" });
	...
	{
		if(CMLib.law().mayOwnThisItem(mob, item))
		{
			mob.tell(L("@x1 is not a stolen item.",item.name(mob)));
			return false;
		}
		return true;
	}
