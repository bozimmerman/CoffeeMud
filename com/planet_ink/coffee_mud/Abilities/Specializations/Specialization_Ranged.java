...
public class Specialization_Ranged extends Specialization_Weapon
{
	...
	private final static String[] EXPERTISES={"RANGEDSTRIKE","RANGEDBASH","RANGEDPIERCE"};
	private final static String[] EXPERTISE_NAMES={"Ranged Striking","Ranged Bashing","Ranged Piercing"};
	private final static String[] EXPERTISE_STATS={"DEX","INT","INT"};
	private final static int[] EXPERTISE_LEVELS={24,27,27};
	private final int[] EXPERTISE_DAMAGE_TYPE={0,Weapon.TYPE_BASHING,Weapon.TYPE_PIERCING};
