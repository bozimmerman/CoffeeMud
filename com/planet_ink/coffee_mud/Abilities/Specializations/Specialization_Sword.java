...
public class Specialization_Sword extends Specialization_Weapon
{
	...
	private final static String[] EXPERTISES={"SWORDSTRIKE","SWORDSLICE","SWORDPIERCE"};
	private final static String[] EXPERTISE_NAMES={"Sword Striking","Sword Slicing","Sword Piercing"};
