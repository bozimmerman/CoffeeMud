...
public class WeatherAffects extends PuddleMaker
{
	...
	protected boolean isInAreaWeather(final Area A, final MOB M)
	{
		if(!isInArea(A,M))
			return false;
		if(weather(A, M.location())==Climate.WEATHER_CLEAR)
			return false;
		return !inATent(M);
	}
