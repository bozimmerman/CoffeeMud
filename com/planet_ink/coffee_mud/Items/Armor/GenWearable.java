...
*/
public class GenWearable extends StdWearable
{
	@Override
	public String ID()
	{
	...
	public GenWearable()
	{
		...
		setName("some generic wearable");
		basePhyStats.setWeight(2);
		setDisplayText("some generic wearable sits here.");
		setDescription("");
		baseGoldValue=5;
	...
	public String[] getStatCodes()
	{
		if(codes!=null)
			return codes;
		final String[] MYCODES=CMProps.getStatCodesList(GenWearable.MYCODES,this);
