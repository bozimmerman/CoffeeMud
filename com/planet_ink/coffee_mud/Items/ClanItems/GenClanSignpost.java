 ...
 */
public class GenClanSignpost extends StdClanSignpost
{
	@Override
	public String ID()
	{
		return "GenClanSignpost";
	}

	protected String	readableText	= "";

	public GenClanSignpost()
	{
		super();
		setName("a generic clan signpost");
		setDisplayText("a generic clan signpost is planted firmly in the ground here.");
		setDescription("");
	...
	public String[] getStatCodes()
	{
		if (codes != null)
			return codes;
		final String[] MYCODES = CMProps.getStatCodesList(GenClanSignpost.MYCODES, this);
	...
	{
		if (!(E instanceof GenClanSignpost))
			return false;
