...
*/
public class GenImpulseEngine extends GenShipEngine
{
	@Override
	public String ID()
	{
		return "GenImpulseEngine";
	}

	public GenImpulseEngine()
	{
		super();
		setName("a generic impulse engine");
	...
	{
		if(!(E instanceof GenImpulseEngine))
			return false;
