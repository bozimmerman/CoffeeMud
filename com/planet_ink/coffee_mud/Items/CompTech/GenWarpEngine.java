...
*/
public class GenWarpEngine extends GenShipEngine
{
	@Override
	public String ID()
	{
		return "GenWarpEngine";
	}

	public GenWarpEngine()
	{
		super();
		setName("a generic warp engine");
		basePhyStats.setWeight(5000);
		setDisplayText("a generic impulse warp sits here.");
		setDescription("");
