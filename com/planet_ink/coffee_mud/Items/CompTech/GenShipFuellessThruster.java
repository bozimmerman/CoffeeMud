...
*/
public class GenShipFuellessThruster extends StdShipFuellessThruster
{
	@Override
	public String ID()
	{
		return "GenShipFuellessThruster";
	}

	protected String readableText="";

	public GenShipFuellessThruster()
	{
		super();
		setName("a generic space drive");
		setDisplayText("a generic space drive sits here.");
	}
	...
	private final static String[] MYCODES={"POWERCAP","POWERREM","MAXTHRUST","ACTIVATED",
	...
	public String[] getStatCodes()
	{
		if(codes!=null)
			return codes;
		final String[] MYCODES=CMProps.getStatCodesList(GenShipFuellessThruster.MYCODES,this);
	...
	{
		if(!(E instanceof GenShipFuellessThruster))
			return false;
