...
*/
public class GenSSEnviro extends GenShipComponent 
implements ShipComponent.ShipEnviroControl
{
	public String ID(){	return "GenSSEnviro";}
	public GenSSEnviro()
	{
		super();
	...
	{
		if(!(E instanceof GenSSEnviro)) return false;
