...
public class GenShipItem extends StdShipItem
{
	...
	{
		super();
		setName("a generic electrical ship item");
		baseEnvStats.setWeight(2);
		setDisplayText("a generic electrical sip item sits here.");
		setDescription("");
		baseGoldValue=5;
	...
	public String[] getStatCodes()
	{
        ...
        String[] MYCODES=CMProps.getStatCodesList(GenShipItem.MYCODES,this);
