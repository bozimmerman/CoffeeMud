...
public class Frog extends StdRace
{
	...
	public Weapon myNaturalWeapon()
	{
		if(naturalWeapon==null)
		{
			...
			naturalWeapon.setName("a slippery tongue");
	...
	public String healthText(MOB mob)
	{
		...
		if(pct<.10)
			return "^r" + mob.displayName() + "^r is facing a cold death!^N";
		else
		if(pct<.20)
		...
		if(pct<.90)
			return "^g" + mob.displayName() + "^g has a few bruises and scratched scales.^N";
		else
		if(pct<.99)
