...
*/
public class GiantBoar extends Pig
{
	@Override
	public String ID()
	{
	...
	private final static String localizedStaticName = CMLib.lang().L("Giant Boar");
	...
	private final String[]	racialAbilityNames			= { "PigSpeak", "Fighter_Charge" };
	...
	public List<RawMaterial> myResources()
	{
		synchronized(resources)
		{
			if(resources.size()==0)
			{
				...
				resources.addElement(makeResource
				(L("a pair of @x1 tusks",name().toLowerCase()),RawMaterial.RESOURCE_BONE));
			}
		}
		return resources;
	}
