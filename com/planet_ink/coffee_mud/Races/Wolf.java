...
public class Wolf extends StdRace
{
	...
	protected int shortestMale(){return 15;}
	protected int shortestFemale(){return 15;}
	...
	public String healthText(MOB mob)
	{
		...
		if(pct<.20)
			return "^r" + mob.displayName() + "^r is covered in blood and matted hair.^N";
		else
		if(pct<.30)
			return "^r" + mob.displayName() + "^r is bleeding badly from lots of wounds.^N";
		else
		if(pct<.40)
			return "^y" + mob.displayName() + "^y has large patches of bloody matted fur.^N";
		else
		if(pct<.50)
			return "^y" + mob.displayName() + "^y has some bloody matted fur.^N";
		else
		if(pct<.60)
		...
		if(pct<.80)
			return "^g" + mob.displayName() + "^g has a cut patch of fur.^N";
		else
		if(pct<.90)
			return "^g" + mob.displayName() + "^g has some disheveled fur.^N";
		else
		if(pct<.99)
			return "^g" + mob.displayName() + "^g has some misplaced hairs.^N";
		else
