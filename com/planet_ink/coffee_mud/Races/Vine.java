...
public class Vine extends StdRace
{
	...
	public String healthText(MOB mob)
	{
		...
		if(pct<.70)
			return "^p" + mob.displayName() + "^p is showing numerous threads.^N";
		else
		if(pct<.80)
			return "^g" + mob.displayName() + "^g is showing some threads.^N";
		else
		if(pct<.90)
			return "^g" + mob.displayName() + "^g is showing small threads.^N";
		else
		if(pct<.99)
