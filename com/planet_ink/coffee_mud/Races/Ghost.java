...
public class Ghost extends Spirit
{
	...
	private final static String localizedStaticName = CMLib.lang().L("Ghost");
	...
	private final String[]	racialAbilityNames			= { "Spell_Fear" };
	...
	private final String[]	racialEffectNames			= { "Immunities" };
	private final int[]		racialEffectLevels			= { 1 };
	private final String[]	racialEffectParms			= { "ALL" };
