...
public class DrowPriestess extends DrowElf
{
	...
	public DrowPriestess()
	{
		...
		baseCharStats().setMyClass(new Cleric());
...
//        commands.addElement();
        boolean prayerSuccess = prayer.invoke(this, commands);
        //System.out.println("Spell:        " + prayer.ID());
        //System.out.println("Proficiency:  " + prayer.profficiency());
        //System.out.println("Success:  " + prayerSuccess);
        return true;
