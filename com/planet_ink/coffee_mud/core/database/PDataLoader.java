...
public class PDataLoader
{
	...
	public PDataLoader(final DatabaseEngine engine, final DBConnector newDB)
	{
		this.DB=newDB;
		this.engine=engine;
	}
	...
	public List<PAData> DBRead(String playerID, String section)
	{
		DBConnection D=null;
	...
	public List<PAData> DBRead(String playerID, String section, String key)
	{
		DBConnection D=null;
		final Vector<PAData> rows=new Vector<PAData>();
		try
	...
	public List<PAData> DBRead(String section)
	{
		DBConnection D=null;
		final Vector<PAData> rows=new Vector<PAData>();
		try
	...
	public List<PAData> DBRead(String playerID, final List<String> sections)
	{
		DBConnection D=null;
		final Vector<PAData> rows=new Vector<PAData>();
	...
	public PAData DBReCreate(String name, String section, String key, final String xml)
	{
	...
	public PAData DBCreate(String playerID, String section, String key, final String data)
	{
		playerID = DB.injectionClean(playerID);
		section = DB.injectionClean(section);
		key = DB.injectionClean(key);
		final PAData pData = createPlayerData();
		pData.who(playerID);
	...
	public PAData createPlayerData()
	{
		return new PAData()
		{
			private String	who		= "";
			...
			@Override
			public PAData who(final String who)
			{
				this.who = who;
				return this;
			}
			...
			@Override
			public PAData section(final String section)
			{
			...
			@Override
			public PAData key(final String key)
			{
				this.key = key;
				return this;
			}
			...
			@Override
			public PAData xml(final String xml)
			{
				this.xml = xml;
				return this;
			}
