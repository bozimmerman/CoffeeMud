...
*/
public class CMVars extends Properties
{
    ...
    public static void loadCommonINISettings(CMVars page)
    {
    ...
    public static String getDefaultMXPImage(Object O)
    {
        ...
        if(O instanceof com.planet_ink.coffee_mud.core.interfaces.Map)
	...
	public CMVars(Properties p, String filename)
	{
		super(p);
	...
	public static CMVars loadPropPage(String iniFile)
	{
        CMVars page=null;
		if (page==null || !page.loaded)
		{
            page=new CMVars(iniFile);
			if(!page.loaded)
				return null;
		}
		return page;
