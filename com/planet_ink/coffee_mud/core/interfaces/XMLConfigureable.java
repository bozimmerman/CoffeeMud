...
*/
/**
 * Interface for classes that are configured or defined using internal XML.
 * @author Bo Zimmerman
 *
 */
public interface XMLConfigureable
{
	/**
	 * Returns an XML representation of all the data in this object, for
	 * persistent storage.
	 *
	 * @see com.planet_ink.coffee_mud.core.interfaces.XMLConfigureable#setXML(String)
	 *
	 ...
	 *
	 * @see com.planet_ink.coffee_mud.core.interfaces.XMLConfigureable#getXML()
	 *
